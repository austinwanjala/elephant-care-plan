                  ...
                  >
                    <div className={cn(
                      ...
                      <item.icon className={cn(
                        ...
                        isActive(item.url) ? "text-blue-600 dark:text-blue-400" : "text-slate-600 dark:text-slate-300 group-hover/btn:text-blue-600 dark:group-hover/btn:text-blue-300"
                      )} />
                    </div>
                    <span className={cn(
